...
def main() -> None:
    ...
    result = {
        ...
        "provenance": (
            "This number is valid ONLY for the cpu_model / core count recorded "
            "above, on the machine that produced this file. It must NOT be used "
            "as the reference for the article's wall-clock estimates unless it "
            "was produced on the machine that will run the screen. Re-run this "
            "script on that machine and overwrite this file."
        ),
